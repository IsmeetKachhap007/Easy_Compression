...
const localeData: LocaleData = {
  ...
  optionPannel: {
    ...
    help: "Easy Compression est une application de compression d'images par lot. Les modifications apportées aux options seront appliquées à toutes les images.",
